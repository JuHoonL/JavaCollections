...
public class Arrays03 {
	...
	public static void main(String[] args) {
		...
		arrBookVO[1].setStrComp("영진 미디어");
		
		arrBookVO[2] = new BookVO();
		
		//배열은 일단 정해진 개수로 생성이 된 후 다시 크기(개수)를 늘리거나 줄이기 위해 다시 생성을 하면
		//원래 배열에 들어있던 값들은 접근할 수 없다. 그래서 배열은 한번 크기가 정해져 생성되면
		//그 크기를 변경 할 수 없다. (거의 불가능)
